...
export const ArduinoProjects: ArduinoProjectModel[] = [
	{
		...
		dateCompleted: '2050-01-01',
		imagePath: "assets/ArduinoFerrofArt/ferrofArt-electromagnet-housing-with-15-magnets.jpg",
		moreImagesPath: [
			"assets/ArduinoFerrofArt/ferrofArt-electromagnet-housing-with-15-magnets.jpg", //0
			"assets/ArduinoFerrofArt/ferrofArt-electromagnet-board-connected.jpg",
			"assets/ArduinoFerrofArt/ferrofArt-5-electromagnets-in-housing.jpg",
			"assets/ArduinoFerrofArt/ferrofArt-adding-brine-to-tank.jpg",
			"assets/ArduinoFerrofArt/ferrofArt-arduino-electromagnet-test.jpg",
			"assets/ArduinoFerrofArt/ferrofArt-brine-filter.jpg",
			"assets/ArduinoFerrofArt/ferrofArt-brine-filtering.jpg", //10
			"assets/ArduinoFerrofArt/ferrofArt-brine-leach.jpg",
			"assets/ArduinoFerrofArt/ferrofArt-brine-prep.jpg",
			"assets/ArduinoFerrofArt/ferrofArt-building-electromagnet-board-1.jpg",
			"assets/ArduinoFerrofArt/ferrofArt-building-electromagnet-board-bottom.jpg",
			"assets/ArduinoFerrofArt/ferrofArt-building-electromagnet-board-top.jpg",
			"assets/ArduinoFerrofArt/ferrofArt-building-electromagnet-central-arduino-board.jpg",
			"assets/ArduinoFerrofArt/ferrofArt-central-arduino-electromagnet-board-connected-to-3-boards.jpg",
			"assets/ArduinoFerrofArt/ferrofArt-electromagnet-housing-filing.jpg",
			"assets/ArduinoFerrofArt/ferrofArt-electromagnet-housing-grid.jpg", //20
			"assets/ArduinoFerrofArt/ferrofArt-electromagnets-in-housing-profile.jpg",
			"assets/ArduinoFerrofArt/ferrofArt-electromagnets-in-housing1.jpg",
			"assets/ArduinoFerrofArt/ferrofArt-ferrofluid-vertical-movement-success.jpg",
			"assets/ArduinoFerrofArt/ferrofArt-ferrofluid-weighing.jpg",
			"assets/ArduinoFerrofArt/ferrofArt-full-testing-setup-with-bottle.jpg",
			"assets/ArduinoFerrofArt/ferrofArt-glass-sanitized.jpg",
			"assets/ArduinoFerrofArt/ferrofArt-injecting-sealant-with-syringe.jpg",
			"assets/ArduinoFerrofArt/ferrofArt-stain-testing-jar.jpg",
			"assets/ArduinoFerrofArt/ferrofArt-stain-testing-tank.jpg",
			"assets/ArduinoFerrofArt/ferrofArt-syringe-in-vice.jpg",
			"assets/ArduinoFerrofArt/ferrofArt-tank-opening-salt-leach.jpg",
			"assets/ArduinoFerrofArt/ferrofArt-tank-seal-opening-closeup.jpg",
			"assets/ArduinoFerrofArt/ferrofArt-transistor-circuit.jpg",
			"assets/ArduinoFerrofArt/ferrofArt-weighing-salt.jpg",
			"assets/ArduinoFerrofArt/ferrofArt-white-sealant-injected.jpg",
			"assets/ArduinoFerrofArt/ferrofArt-add-salt-to-flask.jpg",
			"assets/ArduinoFerrofArt/ferrofArt-adding-ferrofluid-to-bottle.jpg",
			"assets/ArduinoFerrofArt/ferrofArt-tank-profile-in-wood.jpeg",
			"assets/ArduinoFerrofArt/ferrofArt-arduino-pcb-map.jpg",
			"assets/ArduinoFerrofArt/ferrofArt-brine-mixing.jpg",
			"assets/ArduinoFerrofArt/ferrofArt-ferrofluid-temperature-monitoring-during-evaporation.jpg",
			"assets/ArduinoFerrofArt/ferrofArt-removing-top-layer-of-ferrofluid.jpg",

		],
		imageCaption: [
			"electromagnet housing with 15 magnets",
			"electromagnet board connected",
			"5 electromagnets in housing",
			"adding brine to tank",
			"Arduino electromagnet test",
			"brine filter",
			"brine filtering",
			"brine leach",
			"brine prep",
			"building electromagnet board 1",
			"building electromagnet board bottom",
			"building electromagnet board top",
			"building electromagnet central Arduino board",
			"central Arduino electromagnet board connected to 3 boards",
			"electromagnet housing filing",
			"electromagnet housing grid",
			"electromagnets in housing profile",
			"electromagnets in housing1",
			"ferrofluid vertical movement success",
			"ferrofluid weighing",
			"full testing setup with bottle",
			"glass sanitized",
			"injecting sealant with syringe",
			"stain testing jar",
			"stain testing tank",
			"syringe in vice",
			"tank opening salt leach",
			"tank seal opening closeup",
			"transistor circuit",
			"weighing salt",
			"white sealant injected",
			"add salt to flask",
			"adding ferrofluid to bottle",
			"tank profile in wood",
			"Arduino pcb map",
			"brine mixing",
			"ferrofluid temperature monitoring during evaporation",
			"removing top layer of ferrofluid",
		...
		components: [
			"**CLEANING SUPPLIES**",
			"Ammonia: Kroger All Purpose Ammonia (few $ bucks)",
			"Hand cleaner: Permatex Fast Orange ($7.50 for 64 ounces)",
			"Nitrile gloves",
			"Hydrochloric Acid: ($25 1 quart)",
			"Distilled white vinegar (from the vinegar bottle used as testing vessel)",
			"**BRINE & FERROFLUID SUPPLIES**",
			"Salt: Alessi Pure Natural Kosher Salt (no additives; no anti-caking agent) ($4 for 386g; 1 container)",
			"Reagent-Grade Sodium Chloride (500g for $20): (this is not worth the money; just use kosher salt with no additives)",
			"Water: Kroger Distilled Water (few $ bucks per gallon)",
			"Ferrofluid: FerroTec EFH1 (2 ounces for $27)",
			"Jars: ($9 for 3): Not as air tight and waterproof as it says",
			"Fish tank: (for testing solutions): ($19)",
			"Distilled white vinegar bottle",
			"1000+ml flask",
			"50ml beaker",
			"Coffee filters",
			"**ELECTRONIC SUPPLIES**",
			...
			"Arduino Mega for minimal grid testing",
			"Teensy 4.1 (looking into this as it has 35 PWM pins! At this scale, power management and heat will become a more complicated situation, though)",
			"Electromagnets",
			"uxcell 5V 50N (these are too big)",
			"KEYESTUDIO 5V (these have breakout boards and don’t need mosfet transistors, diodes and resistors but don’t stack in both directions: ($9 each)",
			"12V 25N 20mm(diameter) x 15mm(height) x30",
			"Transistors: Logic Level Mosfets: WeiMeet RFP30N06LE 30A 60V N-Channel Power Mosfe or bojack x30",
			"Diodes: 1N40007 x30",
			"Resistors: 10k x30",
			"Breadboards",
			"Jumper wires",
			"Wire ~20 gauge threaded: red, black + 5 colors x hundreds",
			"Power adapters",
			"For Arduino: 9v 1amp",
			"For Magnets: 5V 2amps",
			"JST connectors",
			"PCBs (7+)",
			"PCB standoffs",
			"PCB pin things that solder to microcontrollers",
			"DC port",
			"**LAB EQUIPMENT**",
			"Hot Plate/Stirrer: Slendor ($65)",
			"Glass petri dish",
			"Flask: 1000+ ml (with rubber plug)",
			"Hot glue gun & glue",
			"Kitchen scale (max up to 10 pounds but used here for grams)",
			"Drug scale (hundredths of grams up to 50 grams)",
			"Slant pointed syringes",
			"Temperature probe",
			"**TOOLS & NON-LAB EQUIPMENT**",
			"Router - for cutting out groove in frame",
			"Clamps",
			"Caulk gun",
			"JST crimper tool",
			"Soldering iron",
			...
			"Screws for magnets",
			"**TANK SUPPLIES**",
			"Silicone Caulk: Clear Silicone 1 ($24 for 2) (also need caulk gun)",
			"Glass: cutting boards: ($21)",
			"Sticks: I used 6mm diameter sticks sold as skewers for marshmallows for campfires.",
			"**HOUSING SUPPLIES**",
			"Wood: 2x2 by length of tank",
			"Tank frame (use whatever you have)",
			"Housing cover",
			"Aluminum housing",
			"Screws for attaching magnets",
			"Wood glue",
			"Screws for housing cover and tank frame",
			"PowerGrab Ultimate Caulk",
		],
		libraries: [
			"none"
		]
